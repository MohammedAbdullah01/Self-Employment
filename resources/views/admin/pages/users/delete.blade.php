...
<!-- Modal -->
<div class="modal fade" id="delete_user{{ $user->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('admin.user.delete', $user->id) }}" method="post">
                ...
                <div class="modal-body">
                    <img class="img-thumbnail" height="200px" width="200px" src="{{ $user->PictureFreelancer }}">
