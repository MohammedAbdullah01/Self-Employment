...
@section('title', 'Freelancer | Sign Up')
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 order-2 order-md-1">
                    ...
                    <form action="{{ route('user.store.register') }}" method="POST" class="row">
                        @csrf
                        @method('POST')
                        ...
                        <div class="col-12">
                            <a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block"
                                ...
                                <p>{{ __('Has An Account As Freelancer ') }}</p>
                            </a>
                        </div>
                    </form>
                </div>
